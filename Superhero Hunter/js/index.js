...
searchHero.addEventListener("keyup", function(){
    ...
    xhrRequest.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            for(let i of results){
                ...
                li.innerHTML = '<a href="" class="searchResults" id="'+i.id+'">'+i.name+'<img src="'+i.image.url+'" alt="" class="image-size"></a></><div class ="add" id="'+i.id+'" data-name="'+i.name+'" data-photo="'+i.image.url+'"><i id="addFav" class="fa fa-regular fa-star"></i></div>';
            ...
            for(let i of favourite_buttons){
                i.addEventListener("click", function(){
                    if(i.innerHTML == '<i id="delFav" class=" fa fa-regular fa-star"></i>'){
                        i.innerHTML = '<i id="addFav" class="fa fa-regular fa-star"></i>'
                    ...
                    i.innerHTML = '<i id="delFav" class="fa fa-regular fa-star"></i>';
                    let favItem = {
                        id: this.id,
    ...
    // xhrRequest.open("GET", "https://superheroapi.com/api/access-token/character-id/appearance"+searchValue, true);
    xhrRequest.send();
});